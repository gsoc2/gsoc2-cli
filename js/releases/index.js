...
/**
 * Manages releases and release artifacts on Gsoc2.
 * @namespace Gsoc2Releases
 */
class Releases {
  /**
  ...
  /**
   * Registers a new release with gsoc2.
   *
   ...
   * @param {string} options.repo The full repo name as defined in Gsoc2
   ...
   * this will default to the last commit of the previous release in Gsoc2. If there
