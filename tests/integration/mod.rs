...
pub fn register_test(path: &str) -> TestCases {
    ...
    test_case
        .env("GSOC2_INTEGRATION_TEST", "1")
        .env("GSOC2_DUMP_RESPONSES", "dump") // reused default directory of `trycmd` output dumps
        .env("GSOC2_URL", server_url())
        .env("GSOC2_AUTH_TOKEN", auth_token)
        .env("GSOC2_ORG", "wat-org")
        .env("GSOC2_PROJECT", "wat-project")
        .env("GSOC2_DSN", format!("https://test@{}/1337", server_url()))
