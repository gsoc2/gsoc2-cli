...
use console::style;
use gsoc2::protocol::{Frame, Stacktrace};
use url::Url;
...
// https://github.com/gsoc2/gsoc2/blob/623c2f5f3313e6dc55e08e2ae2b11d8f90cdbece/src/gsoc2/lang/javascript/processor.py#L145-L207
...
pub fn execute(matches: &ArgMatches) -> Result<()> {
    ...
    warning("DEPRECATION: `sourcemaps explain` has drifted from how sourcemap processing actually operates \
        and its output may not be accurate. It will be removed in a future version of `gsoc2-cli`.");
...
fn test_resolve_sourcemap_url() {
    // Tests coming from `tests/gsoc2/utils/test_urls.py` in `gsoc2/gsoc2`
    let cases = vec![
