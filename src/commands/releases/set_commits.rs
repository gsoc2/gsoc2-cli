    ...
    command
        ...
        .arg(Arg::new("auto")
            ...
            .help("Enable completely automated commit management.{n}\
                    ...
                    gsoc2-cli will then automatically find remotely configured \
        ...
        .arg(Arg::new("commits")
            ...
            .help("Defines a single commit for a repo as \
                    identified by the repo name in the remote Gsoc2 config. \
                    If no commit has been specified gsoc2-cli will attempt \
                    ...
                    The value can be provided as `REPO` in which case gsoc2-cli \
