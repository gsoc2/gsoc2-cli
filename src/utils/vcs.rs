...
fn test_find_matching_rev_with_lightweight_tag() {
    ...
    let spec = CommitSpec {
        repo: String::from("gsoc2/gsoc2-cli"),
    ...
    let repos = [Repo {
        id: String::from("1"),
        name: String::from("gsoc2/gsoc2-cli"),
        url: Some(String::from("https://github.com/gsoc2/gsoc2-cli")),
...
fn test_url_parsing() {
    ...
    assert_eq!(
        VcsUrl::parse("https://neilmanvar.visualstudio.com/_git/gsoc2-demo"),
        VcsUrl {
            provider: "neilmanvar.visualstudio.com".into(),
            id: "neilmanvar/gsoc2-demo".into(),
        }
    );
    assert_eq!(
...
fn git_initialize_repo() -> TempDir {
    ...
    Command::new("git")
        .args([
            ...
            "add",
            "origin",
            "https://github.com/gsoc2/gsoc2-cli",
        ])
        .current_dir(&dir)
        .spawn()
